...
CREATE INDEX IF NOT EXISTS idx_integration_marketplace_category ON integration_marketplace(category);
CREATE INDEX IF NOT EXISTS idx_integration_marketplace_slug ON integration_marketplace(slug);
CREATE INDEX IF NOT EXISTS idx_integration_marketplace_featured ON integration_marketplace(is_featured) WHERE is_featured = true;
CREATE INDEX IF NOT EXISTS idx_integration_marketplace_verticals ON integration_marketplace USING GIN(recommended_for_verticals);

CREATE INDEX IF NOT EXISTS idx_bot_integrations_bot_id ON bot_integrations(bot_id);
CREATE INDEX IF NOT EXISTS idx_bot_integrations_integration_id ON bot_integrations(integration_id);
CREATE INDEX IF NOT EXISTS idx_bot_integrations_status ON bot_integrations(status);

CREATE INDEX IF NOT EXISTS idx_integration_logs_bot_integration_id ON integration_logs(bot_integration_id);
