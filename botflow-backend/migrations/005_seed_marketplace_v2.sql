-- Migration 005: Seed Integration Marketplace (V2 - Final Fix)
...
-- Remove the auth_type constraint if it exists
ALTER TABLE integration_marketplace DROP CONSTRAINT IF EXISTS integration_marketplace_auth_type_check;
