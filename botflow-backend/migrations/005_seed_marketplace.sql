-- Migration 005: Seed Integration Marketplace
-- Phase 2: Populate marketplace with popular integrations
-- Created: 2026-01-17
-- Purpose: Fix empty marketplace search results

-- First, ensure the integration_marketplace table exists (it should from earlier migration)
CREATE TABLE IF NOT EXISTS integration_marketplace (
  ...
  is_direct_integration BOOLEAN DEFAULT true,
  recommended_for_verticals TEXT[] DEFAULT '{}',
