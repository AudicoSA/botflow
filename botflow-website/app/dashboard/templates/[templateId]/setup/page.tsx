...
export default function TemplateSetupPage() {
  ...
  const [whatsappConnected, setWhatsappConnected] = useState(true); // Assume connected initially
  ...
  const checkWhatsAppConnection = () => {
    if (typeof window !== 'undefined') {
      ...
      setWhatsappConnected(!!whatsappAccountId);
    }
  };
  ...
  const handleCreateBot = async () => {
    ...
    try {
      ...
      if (!organizationId || !whatsappAccountId) {
        // Redirect to integrations page instead of showing error
        alert('Please connect your WhatsApp account first before creating a bot.');
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3 flex-1">
              ...
              <div className="mt-2 text-sm text-yellow-700">
                <p>You need to connect your WhatsApp account before creating a bot.</p>
              </div>
              <div className="mt-4">
                <button
