            ...
            <div className="max-w-md w-full">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-gray-300 rounded-lg font-semibold text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition-all"
                    >
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-gray-600">
                            ...
                            <Link href="/signup" className="text-primary-blue font-semibold hover:underline">
                                Sign up
                            </Link>
                        </p>
                    </div>
