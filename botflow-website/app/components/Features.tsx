        ...
        <section id="features" className="py-24 px-6">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-4xl lg:text-5xl font-extrabold mb-4">Why BotFlow?</h2>
                    <p className="text-xl text-gray-600">Everything you need to automate customer conversations</p>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className="p-8 rounded-2xl border border-gray-200 hover:border-primary-blue hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group"
                        >
