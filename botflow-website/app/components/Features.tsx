            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        ...
                        >
                            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-surf-DEFAULT to-surf-dark flex items-center justify-center text-white mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-md">
                                {feature.icon}
                            </div>
